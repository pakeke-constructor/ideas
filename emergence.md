...
I am making my own game, called "Untitled Mod Game".
It's a game based fully on mods, (similar to Garry's mod, but 2d.)

As such, I want to ensure that the systems in UMG are sufficiently emergent to provide
a fun experience for the players.

All in all, my main "mantra" so to speak for UMG can be summed up like do:

- Don't create systems that provide gameplay...
- Instead, create systems that provide rules;
- Gameplay is then generated by the players, when the players interact with the rules.
